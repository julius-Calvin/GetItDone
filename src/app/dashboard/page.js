...
export default function Page() {
    ...
    return (
        <div className="flex min-h-screen w-full relative overflow-x-hidden bg-surface transition-theme">
            {/* Mobile top bar */}
            <div className="md:hidden fixed top-0 left-0 right-0 z-40 flex items-center justify-between bg-surface-alt dark:bg-black border-b border-base px-4 h-14 transition-theme">
                <button
                    type="button"
                ...
                <h1 className="font-bold text-[#A23E48] dark:text-[#A23E48]">Get It Done</h1>
                <div className="w-10" />
            </div>
            ...
            <div className="flex-1 flex flex-col w-full md:pl-0 pt-14 md:pt-0 transition-theme">
